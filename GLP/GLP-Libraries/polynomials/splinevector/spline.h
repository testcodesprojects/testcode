...
private:
    ...
    col_vector m_a,m_b,m_c;        // spline coefficients
...
// solves Ly=b
col_vector band_matrix::l_solve(const col_vector& b) const
{
...
// solves Rx=y
col_vector band_matrix::r_solve(const col_vector& b) const
{
    assert( this->dim()==(int)b.size() );
    col_vector x(this->dim());
    int j_stop;
...
col_vector band_matrix::lu_solve(const col_vector& b,
...
void spline::set_points(const col_vector& x,
...
void spline::operator() (col_vector &seq_x,col_vector &dens_seq_x) const
{
